...
function AddAdmin(props) {
    ...
    const addAdmin = async () => {
        ...
        await http.post(`/auth/register/admin`, formData).then(response => {
            Swal.fire({
                icon: "success",
    ...
    return (
        <>
            <Form>
                ...
                <div>
                    <button className="btn btn-primary" type="button" onClick={e => addAdmin()} >Ajouter administrateur</button>
                </div>
            </Form>
