        ...
        validators: {
            postcode: {
                ...
                rule: (val, params, validator) => {
                    return validator.helpers.testRegex(val, /[0-9]{5}/g)
                }
            },
            ...
            <Form>
                <div className="mb-4">
                    <div className="col">
                        ...
                        {validator.message('intitulé de l\'offre ', title, 'required', { className: 'text-danger' })}
                    </div>
                    <div className="col">
                ...
                <div className="mt-4">
                    <button className="btn btn-primary" type="button" onClick={e => addCompany()} >Ajouter Offre d'emploi</button>
                </div>
            </Form>
