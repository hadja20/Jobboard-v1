...
import AddPostRecruiter from "./AddPostRecruiter";
import EditPostRecruiter from "./EditPostRecruiter";

function PostRecruiter() {
    ...
    const getAllPosts = async () => {
        await http.get(`/auth/recruiters/${user.id}/advertisements`)
            .then(res => {
    ...
    return (
        <>
            ...
            <Dialog open={open}>
                ...
                <DialogContent>
                <EditPostRecruiter post={p}  recruteur={user} getAllPosts={getAllPosts} close={handleClose}/>   
                </DialogContent>
                <DialogActions>
            ...
            <Dialog open={openAdd}>
                ...
                <DialogContent>
                <AddPostRecruiter recruteur={user} closeAddPost={closeAddPost} getAllPosts={getAllPosts} />
                </DialogContent>
                <DialogActions>
